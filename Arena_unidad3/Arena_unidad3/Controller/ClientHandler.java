...
public class ClientHandler implements Runnable {
   ...
   private void checkVictory() {
    if (!opponent.getPlayer().isAlive()) {
        ...
        // Llama a finalizarPartida para detener regeneración y mostrar ranking
        finalizarPartida(this, opponent);
    }
}

private void finalizarPartida(ClientHandler ganador, ClientHandler perdedor) {
    // Detener regeneración de ambos jugadores
    ganador.getPlayer().stopRegen();
    perdedor.getPlayer().stopRegen();

    // Mostrar ranking y cualquier otra lógica de cierre
    GameServer.mostrarRanking(ganador, perdedor);

    // ...código adicional para cerrar sockets, notificar a los clientes, etc...
}
